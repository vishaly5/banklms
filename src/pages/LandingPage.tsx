...
const navItems = ['Home', 'Courses', 'AI Tools', 'Certificates', 'About Us'];
    ...
    <main className="bharat-landing">
      ...
      <section className="hero-stage" aria-labelledby="hero-title">
        ...
        <div className="hero-copy">
          ...
          <p>
            India's most advanced Cooperative Learning Platform with AI-powered education, certificates and analytics.
          </p>
