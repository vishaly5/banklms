...
async function populateDatabase() {
  try {
    ...
    const participantHash = await bcrypt.hash('Participant@123', 12);
    ...
    await participantsCollection.insertMany([
      ...
      },
      {
        firstName: "Priya",
        lastName: "Patel",
        email: "priya.participant@ncui.in",
        mobile: "7777777776",
        password: participantHash,
        role: "participant",
        isApproved: true,
      ...
      },
      {
        firstName: "Amit",
        lastName: "Verma",
        email: "amit.participant@ncui.in",
        mobile: "7777777775",
        password: participantHash,
        role: "participant",
        isApproved: false,
    ...
    await participantsCollection.createIndex({ email: 1 }, { unique: true });
    await participantsCollection.createIndex({ mobile: 1 }, { unique: true });
    ...
    console.log(`   Participants: ${totalParticipants} (in 'participants' collection)`);
    console.log(`   Total Users: ${totalAdmins + totalTrainers + totalParticipants}`);
    ...
    console.log('\n👨‍🏫 TRAINERS (2 Approved, 1 Pending):');
    console.log('   trainer@ncui.in / Trainer@123 (Approved)');
    console.log('   rajesh.trainer@ncui.in / Trainer@123 (Approved)');
    console.log('   priya.trainer@ncui.in / Trainer@123 (Pending)');
    
    console.log('\n👨‍🎓 PARTICIPANTS (8 Approved, 2 Pending):');
    console.log('   participant@ncui.in / Participant@123 (Approved)');
    console.log('   priya.participant@ncui.in / Participant@123 (Approved)');
    console.log('   rahul@ncui.in / Participant@123 (Approved)');
    console.log('   sneha@ncui.in / Participant@123 (Approved)');
    console.log('   vikram@ncui.in / Participant@123 (Approved)');
    console.log('   anjali@ncui.in / Participant@123 (Approved)');
    console.log('   karan@ncui.in / Participant@123 (Approved)');
    console.log('   divya@ncui.in / Participant@123 (Approved)');
    console.log('   amit.participant@ncui.in / Participant@123 (Pending)');
    console.log('   arjun@ncui.in / Participant@123 (Pending)');
