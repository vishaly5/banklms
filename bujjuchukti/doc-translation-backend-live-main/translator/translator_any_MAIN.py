...
import os
# 'bn', 'gu', 'hi', 'kn', 'ml', 'mr', 'pa', 'ta', 'te', 'as', 'or','ur', 'ne'
languages = ['hi']
...
os.system(("DocumentTranslatorCmd translatedocuments /documents:" +"C:/Users/AICTE/Music/ganesha_pooja.docx"+ f" /from:en /to:{','.join(languages)}"))
