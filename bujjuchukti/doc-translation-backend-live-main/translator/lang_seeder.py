...
# for k in result:
#     key = "37d9984a024b4b468de99b4c0d01a44e"
...
import os
# 'bn', 'gu', 'hi', 'kn', 'ml', 'mr', 'pa', 'ta', 'te', 'as', 'or','ur'
...
os.system(("DocumentTranslatorCmd translatedocuments /documents:" +"C:/Users/aicte/Work/translation-independent-server-master/translator/JANCH.pdf"+ f" /to:{','.join(languages)}"))
